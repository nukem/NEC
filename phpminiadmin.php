...
*/
 ...
 $DBDEF=array(
 'user'=>"neccd_db",#required
 'pwd'=>"qwerty123#", #required
 'db'=>"neccd_db",  #optional, default DB
...
function ex_start(){
 ...
 if ($ex_isgz){
	...
	//$ex_tmpf=tempnam('./', 'pma').'.gz';
	$ex_tmpf = '/var/www/vhosts/soundbooka.com.au/httpdocs/version2/application/cache/pma5qQgDi.gz';
