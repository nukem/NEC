...
<div id="page"> 
            ...
            <table class="rec-table"> 
              <tr> 
                <td><label><?= $lang[7] ?> &bull;</label><br /> 
                  <input type="text" name="title" value="<? if (isset ($_POST['title'])) echo htmlspecialchars ($_POST['title']); else echo $record['title']; ?>" maxlength="20" class="textfield width-100pct" /></td> 
  ...
  <?= ereg_replace ('^(.*)-(.*)-(.*) (.*):(.*):(.*)$', '\\3/\\2/2006 \\4:\\5', $record['created']) ?></td> 
  <td><label><?= $lang[50] ?></label><br />
  <?= ereg_replace ('^(.*)-(.*)-(.*) (.*):(.*):(.*)$', '\\3/\\2/2006 \\4:\\5', $record['modified']) ?></td> 
