...
class Read_whiteboard{
    ...
    function process($line){
        ...
        if($line[0] != null){
            ...
            if(substr_count(trim($line[0]),'Access')==0){
                ...
                $this->obj_con->insert('nec_whiteboard_cate',$vals);
                $this->cate_size = $this->obj_con->getId('nec_whiteboard_cate');
            }
            else{
                $this->tag ='a';
            }
        ...
        else if($this->tag == 'a' && trim($line[2]) != null && trim($line[2]) != ""){//else if($this->tag == 'a'){  
            //add to accessories
    ...
    function add_data($line_data,$counter){
        ...
        //print_r($vals);
        $this->obj_con->insert('nec_whiteboard',$vals);
        $this->product_size = $this->obj_con->getId('nec_whiteboard');
    ...
    function add_accessories($line_data,$counter){
        ...
        $vals = array(//'updated'=>$updated,
                      ...
                      'cate_fk'=>$counter);
        //print_r($vals);
        $this->obj_con->insert('nec_whiteboard_access',$vals);
        $access_fk = $this->obj_con->getId('nec_whiteboard_access');
