...
class Read_whitegoods{
    ...
    function process($line){
        ...
        if($line[0] != null){
            ...
            if(substr_count(trim($line[0]),'Access')==0){
                ...
                $this->obj_con->insert('nec_whitegoods_cate',$vals);
                $this->cate_size = $this->obj_con->getId('nec_whitegoods_cate');
            }
            else{
                $this->tag ='a';
            }
    ...
    function add_data($line_data,$counter){
        ...
        //print_r($vals);
        $this->obj_con->insert('nec_whitegoods',$vals);
        $this->product_size = $this->obj_con->getId('nec_whitegoods');
    ...
    function add_accessories($line_data,$counter){
        ...
        $vals = array('code'=>$line_data[2],
                      ...
                      'cate_fk'=>$counter);
        //print_r($vals);
        $this->obj_con->insert('nec_whitegoods_access',$vals);
        $access_fk = $this->obj_con->getId('nec_whitegoods_access');
