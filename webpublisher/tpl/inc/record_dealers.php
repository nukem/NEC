<tr>
  ...
  <select name="approve" class="width-100pct textfield">
	<option value="false">Select an action...</option>
	<option value="approve" <? if(isset($_POST['approve']) && $_POST['approve'] == 'approve'){ echo 'selected="selected"'; }?>>Approve</option>
	<option value="delete" <? if(isset($_POST['approve']) && $_POST['approve'] == 'delete'){ echo 'selected="selected"'; }?>>Delete</option>
  </select>
  </td>
  <td style="display: none;"><input type="hidden" name="sort" value="position" />
