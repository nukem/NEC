...
$GDok = TRUE;
// ------------ config section --------------------
$IMGFOLDER = ''; #full server path to images folder
$IMGURL = ''; # URL path to images folder

$IMG_PATH_REPLACE = ''; # domain name without the trailing slash
...
function maketable($dirname) {
  ...
  while ($file = readdir($handle)) {
     if (($file != '.') && ($file != '..') && preg_match('/\-l.jpg$/', $file)) {
	$file_lista[]=$file;
     }
  };
  closedir($handle);
